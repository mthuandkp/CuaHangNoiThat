...
<div class="header">
    ...
    <div class="product-info">
        <div class="product-info-item">
            <img src="/CuaHangNoiThat/public/image/Banner_phu_2.jpg" alt="">
        </div>
        <div class="product-info-item">
            <div class="product-info-text">
                <div class="product-name">Tủ dô ABCDXYZ</div>
                <div style="font-size: 25px;">Giá:   <div class="price">200.000 <sup>đ</sup></div></div>
