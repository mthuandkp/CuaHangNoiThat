...
<body style="background-image: radial-gradient(#b3b3b3, #ffffff);">
  <div style="width: 30%;margin-left: 35%;font-size: 1.5rem;background-color: white;padding: 2rem;border-radius: 1rem;color:#0066cc;margin-top: 2rem;margin-bottom: 2rem;">
    ...
    <div class="form-group">
      ...
      <img id="currentImageProduct" src="/CuaHangNoiThat/public/image/<?php echo $product['HINHANH']; ?>" alt="error" style="width: 40%;float: right;">
    </div>
    <div class="form-group">
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            if (data[0] == 0) {
              ...
              $("#currentImageProduct").attr('src','/CuaHangNoiThat/public/image/'+data[1]+currentImage);
              return;
            }
